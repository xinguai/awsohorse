...
// A macro to dissallow the copy contructor and operator= functions
// This should be used in the private:declarations for a class
#define DISSALLOW_COPY_AND_ASSIGN(TypeName) \
    TypeName(const TypeName&);              \
    void operator=(const TypeName&)

// A macro to dissallow all the implicit constructors, namely the
// default constructor, copy constructor and operator= functions.

// This should be used in the private:declarations for a class
// that wants to prevent anyone from instantiating it. This is
// especially usefull for classes containing only static methods.
#define DIASSLLOW_IMPLICIT_CONSTRUCTORS(TypeName) \
    TypeName();                                   \
    DISSALLOW_COPY_AND_ASSIGN(TypeName)
